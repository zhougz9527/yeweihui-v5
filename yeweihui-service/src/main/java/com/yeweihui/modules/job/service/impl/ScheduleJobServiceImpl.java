...
package com.yeweihui.modules.job.service.impl;
...
import com.yeweihui.modules.job.dao.ScheduleJobDao;
import com.yeweihui.modules.job.service.ScheduleJobService;
import com.yeweihui.modules.job.utils.ScheduleUtils;
import com.yeweihui.modules.job.entity.ScheduleJobEntity;
...
public class ScheduleJobServiceImpl extends ServiceImpl<ScheduleJobDao, ScheduleJobEntity> implements ScheduleJobService {
	...
	/**
	 * 项目启动时，初始化定时器
	 * yeweihui-admin modules.job.jobInitService
	 */
	@PostConstruct
	public void init(){
		logger.info("ScheduleJobServiceImpl ------------- starting jobInitService---------------");
		List<ScheduleJobEntity> scheduleJobList = this.selectList(null);
		System.out.println(scheduleJobList.toString());
