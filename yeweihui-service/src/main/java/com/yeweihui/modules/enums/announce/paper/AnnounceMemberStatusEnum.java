 ...
 */
public enum AnnounceMemberStatusEnum {
    未读("未读", 0),
    已读("已读", 1),
    ;
    ...
    private AnnounceMemberStatusEnum(String name, int code) {
        this.name = name;
        this.code = code;
    }
    /**
    ...
    public static String getName(int code) {
        for (AnnounceMemberStatusEnum ex: AnnounceMemberStatusEnum.values()) {
            if (ex.getCode()==code) {
                return ex.getName();
            }
        }
