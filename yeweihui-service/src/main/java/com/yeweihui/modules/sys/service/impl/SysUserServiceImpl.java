...
import com.yeweihui.modules.sys.dao.SysUserDao;
...
//		if (null != userEntity) {
//			menuIdList = "行业主管".equals(userEntity.getRoleName()) ?
//					zoneMenuMapDao.queryManagerUserZoneAllMenuId() : zoneMenuMapDao.queryUserZoneAllMenuId(userId);
//		}
//		return menuIdList;
	}
