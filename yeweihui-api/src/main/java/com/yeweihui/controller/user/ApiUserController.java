...
public class ApiUserController {
    ...
    public R simpleListDivide(@RequestBody UserQueryParam userQueryParam){
        List<UserListDivideGroup> userListDivideGroupList = userService.simpleListDivide(userQueryParam);
