...
import com.yeweihui.modules.sys.shiro.RedisShiroSessionDAO;
import com.yeweihui.modules.sys.shiro.UserRealm;
...
public class ShiroConfig {
    ...
    public ShiroFilterFactoryBean shiroFilter(SecurityManager securityManager) {
        ...
        filterMap.put("/jmkj/**", "anon");

        filterMap.put("/statics/**", "anon");
        filterMap.put("/login.html", "anon");
        filterMap.put("/sys/login", "anon");
        filterMap.put("/sys/smsLogin", "anon");
        filterMap.put("/sys/sendVerifyCode", "anon");
