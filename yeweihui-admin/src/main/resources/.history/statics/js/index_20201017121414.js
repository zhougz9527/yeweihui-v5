	...
	methods: {
		getMenuList: function (event) {
			$.getJSON("sys/menu/nav?_"+$.now(), function(r){
				...
				let data = {menuId:0,parentId:0,name:'履职数据',orderNum: 0,type:1,url:'modules/data/data.html'}
				let data1 = {menuId:0,parentId:0,name:'行业主管',orderNum: 0,type:1,url:'modules/director/director.html'}
